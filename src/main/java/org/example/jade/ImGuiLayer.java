...
import org.example.components.MushroomAI;
import org.example.components.PlayerController;
import org.example.components.QuestionBlock;
...
public class ImGuiLayer {
    ...
    private static boolean buyButtonPressed = false;
    ...
    public void update(float dt, Scene currentScene) {
        ...
        currentScene.imgui();
        ImGui.begin("Score");
        ImGui.text("Your Score: " + playerController.getScore());
        ImGui.text("Max Score: " + playerController.loadRecordScore());
        ImGui.end();
        ImGui.begin("Shop Gun");
        if (ImGui.button("AK47 : 50 Point")) {
            // Nếu nút được nhấn, đặt biến buyButtonPressed thành true
    ...
    public boolean buyPressed() {
        System.out.println("buypressed" + buyButtonPressed);
        return buyButtonPressed;
    }

    public boolean buyNotPressed() {
