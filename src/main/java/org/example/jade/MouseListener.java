...
public class MouseListener {
    ...
    //theo dỗi và cập nhật vị trí của chuột
...
//      kiểm tra xem có nút chuột nào đang được nhấn
        if (get().mouseButtonDown > 0) {
//            chuột đang được kéo
            get().isDragging = true;
        }
//     vị trí trước của chuột
        get().lastX = get().xPos;
        get().lastY = get().yPos;
//       vị trí trước trong ko gian thế giới
...
//            tăng giá trị mouseButtonDown => chuột đang được giữ
            get().mouseButtonDown++;
